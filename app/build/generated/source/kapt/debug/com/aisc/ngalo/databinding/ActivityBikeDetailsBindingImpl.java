...
public class ActivityBikeDetailsBindingImpl extends ActivityBikeDetailsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cart, 1);
        sViewsWithIds.put(R.id.cartValue, 2);
        sViewsWithIds.put(R.id.bikeImage, 3);
        sViewsWithIds.put(R.id.textViewsContainer, 4);
        sViewsWithIds.put(R.id.textBikeName, 5);
        sViewsWithIds.put(R.id.textViewPrice, 6);
        sViewsWithIds.put(R.id.detailsDesc, 7);
        sViewsWithIds.put(R.id.textViewDesc, 8);
        sViewsWithIds.put(R.id.checkout_btn, 9);
    }
    // views
    @NonNull
