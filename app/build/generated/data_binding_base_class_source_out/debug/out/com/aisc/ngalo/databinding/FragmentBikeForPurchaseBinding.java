...
public final class FragmentBikeForPurchaseBinding implements ViewBinding {
  ...
  @NonNull
  public static FragmentBikeForPurchaseBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentBikeForPurchaseBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_bike_for_purchase, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentBikeForPurchaseBinding bind(@NonNull View rootView) {
