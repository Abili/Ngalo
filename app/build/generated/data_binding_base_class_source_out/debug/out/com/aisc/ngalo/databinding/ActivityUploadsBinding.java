...
public final class ActivityUploadsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityUploadsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUploadsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_uploads, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUploadsBinding bind(@NonNull View rootView) {
