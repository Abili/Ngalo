...
import com.aisc.ngalo.databinding.UserRideItemBinding
import com.google.firebase.auth.FirebaseAuth

class UsersRidesAdapter : RecyclerView.Adapter<UsersRidesAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = layoutInflater.inflate(R.layout.user_ride_item, parent, false)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val binding: UserRideItemBinding = UserRideItemBinding.bind(itemView)
